...
export default function AnalyticsItem({ text, info, icon, className }) {
  ...
  return (
    <div className={`flex flex-col items-center justify-center gap-2 rounded-lg bg-white dark:bg-[rgb(40,40,40)] p-2 shadow-md transition-all duration-300 hover:bg-gray-100 dark:hover:bg-[rgb(50,50,50)] h-[min(14.75vw,14.75vh)] overflow-visible lg-h:h-[min(15.5vw,15.5vh)] ${className}`}> 
